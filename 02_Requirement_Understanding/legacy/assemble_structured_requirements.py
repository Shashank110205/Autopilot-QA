...
INPUT_PATH    = "../02_Requirement_Understanding/output/requirements_extracted.json"
OUTPUT_DIR    = "../02_Requirement_Understanding/output"
...
def run_pipeline():
    ...
    print("\n🏗️  Step 3: Assembling structured requirements...")
