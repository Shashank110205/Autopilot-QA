...
DEFAULT_GROUPED     = "../02_Requirement_Understanding/output/requirements_extracted_grouped.json"
DEFAULT_STRUCTURED  = "../01_Multi_Source_Document_Ingestion/output/structured_output.json"
DEFAULT_OUTPUT      = "../02_Requirement_Understanding/output/requirements_normalized_for_cru.json"
DEFAULT_AUDIT       = "../02_Requirement_Understanding/output/stage_2c_audit.json"
