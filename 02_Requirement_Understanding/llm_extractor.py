...
Extract the following fields from the requirement text below
and return ONLY a valid JSON object — no markdown, no
...
Extract the following fields and return ONLY a valid JSON object — no markdown, no
explanation, no code fences.
